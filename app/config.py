...
class Config:
    ...
    wunderground_stations: tuple = (("IPEROP1", "IPEROP1"), ("IALMAR8", "IALMAR8"), ("ITERRU5", "ITERRU5"))
    ...
    wind_dir_min: float = 271.0  # just past W (inclusive)
    wind_dir_max: float = 337.0  # just short of NW (inclusive)
